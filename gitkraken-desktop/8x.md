...
- [Team Overview](/gitkraken-desktop/8x/#team-overview) - Added the <kbd>Team Overview</kbd> section for Workspaces:
  - [Team Pull Requests](/gitkraken-desktop/8x/#team-pull-requests) - Shows all Pull Requests for repos in Team Workspace and provided quick actions.
  - [Team Issues](/gitkraken-desktop/8x/#team-issues) - Displays list of all Issues for repos in Team Workspace.
...
- [Workspace UI improvements](/gitkraken-desktop/8x/#workspace-ui-updates)
...
- [Left panel improvements](/gitkraken-desktop/8x/#left-panel-improvement) - Left panel filtering experience improved:
...
<img src="/wp-content/uploads/8-9-team-overview.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/8-9-filter-by-author-assignee.png" class="help-center-img img-bordered">

If your Workspace repos are hosted on GitHub, you may filter the Team Pull Requests by assignee or author.

<img src="/wp-content/uploads/8-9-team-pull-requests-columns.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/8-9-team-issues-switch.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/8-9-GK-Release-8-9.gif" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/8-9-my-issues-switch.png" class="help-center-img img-bordered">

### Left panel improvement
 
In the left panel, you may now expand or collapse sections when filtering the left panel.

<img src="/wp-content/uploads/8-9-left-panel.gif" class="help-center-img img-bordered">
...
- [Single Sign On](/gitkraken-desktop/8x/#what-is-single-sign-on-sso) 
    ...
    - Resources:
        - [Requirements and configuration](/gitkraken-desktop/8x/#requirements-and-configuration)
        - [Signing in with SSO](/gitkraken-desktop/8x/#signing-in-with-sso)

- [Overview in Workspaces](/gitkraken-desktop/8x/#workspace-updates-overview)
...
- [Partial stash](/gitkraken-desktop/8x/#partial-stash-support)
...
- [Left panel improvements](/gitkraken-desktop/8x/#left-panel-improvements)
...
- [New Tab view updates](/gitkraken-desktop/8x/#new-tab-view-updates)
    - The `Recent` and `Favorite Repos` lists have been moved to the top of the `Repositories` section for easier access.
- [More autosuggest in GitKraken CLI](/gitkraken-desktop/8x/#more-autosuggest-in-gitkraken-cli)
...
Ready to get started? Then follow the [How to set up SSO in GitKraken](https://help.gitkraken.com/gitkraken-desktop/single-sign-on/) documentation.

#### Signing in with SSO

GitKraken Client users should see a new option to Sign in with SSO from the login screen.

<img src="/wp-content/uploads/sign-in-with-SSO.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/overview.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/partial-stash-multiple-files.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/apply-stash-multiple-files.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/resize-left-panel.gif" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/left-panel-toggle-sections.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/new-tab-view-updates.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/git-remote-prune.png" class="help-center-img img-bordered">
...
- GitKraken Client now supports the ability to create and apply patches.
    - [Create patch from commit(s)](/gitkraken-desktop/8x/#create-patch-from-commits)
    - [Create patch from uncommitted file(s)](/gitkraken-desktop/8x/#create-patch-from-files)
    - [Create patch from Command Palette](/gitkraken-desktop/8x/#create-patch-from-command-palette)
    - [Apply patch from Command Palette](/gitkraken-desktop/8x/#apply-patch-from-command-palette)
- [Left panel improvements](/gitkraken-desktop/8x/#left-panel-improvements-toggle-sections) - Left Panel now has a context menu to toggle visibility of the different sections.
- [New Tab update](/gitkraken-desktop/8x/#updated-ui-and-layout-for-new-tab-view) - Updated UI and layout.
- [Terminal Tab](/gitkraken-desktop/8x/#repo-aliases-in-terminal-tab-titles) - Repo aliases will now show in Terminal Tab titles.
- [More fuzzy search](/gitkraken-desktop/8x/#fuzzy-search-in-gk-history-and-gk-blame-commands) - Enabled fuzzy search in `gk history` and `gk blame` commands in GitKraken CLI.
- [Search tabs list](/gitkraken-desktop/8x/#users-may-now-search-tabs-by-repo-alias-in-the-tabs-list) - Users may now search tabs by repo alias in the tabs list.
- [Naming branch from issue](/gitkraken-desktop/8x/#name-branch-when-creating-branch-from-issue) - When viewing an issue from inside GitKraken Client, there is now a short text field for naming the branch when creating a branch from the issue.
- [Git LFS performance improvements](/gitkraken-desktop/8x/#git-lfs-performance-improvements):
...
<img src="/wp-content/uploads/create-patch-from-commit.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/create-patch-from-multiple-commits.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/create-patch-from-file.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/create-patch-from-multiple-files.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/apply-patch.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/after-apply-patch.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/new-tab-view.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/alias-terminal-tab.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/gk-history-fuzzy-search.gif" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/search-by-alias.png" class="help-center-img img-bordered">
...
<img src="/wp-content/uploads/name-branch-from-issue.png" class="help-center-img img-bordered">

Consider setting up [Issue Tracker Integrations](l/gitkraken-desktop/jira/) like Jira, Trello, GitHub Issues, or GitLab Issues to get access to this handy feature.
