...
This release notes page tracks what changed in GitKraken Desktop version 10, including new features, improvements, and bug fixes across each release. Use it when you need historical version details, want to confirm when a feature first appeared in version 10, or need to review fixes before upgrading an older installation.

**Requirements and limits**
- This page is a version 10 release history, not the current product reference.
- Each section applies only to the specific version number shown in that release entry.
- Some features described here may have changed, moved, or been deprecated in later releases.
- Use current product docs for present-day behavior and this page to confirm when version 10 changes shipped.
...
### New ✨
 - **Automatic Conflict Detection:** GitKraken will monitor your base branch for conflicts and alert you with an icon in the toolbar when conflicts are detected, providing options to resolve your conflicts sooner rather than later.
   ...
   - You can limit which branches GitKraken may consider as "base branches" when scanning for conflicts. Navigate to _Preferences > Conflict Detection_ to set the preferred branches for a repository.
...
) and in GitKraken Desktop on any device that is logged in to your GitKraken account.
...
### New ✨
 - GitKraken Desktop is now called GitKraken Desktop
