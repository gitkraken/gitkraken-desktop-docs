...
**OpenAI API Key:** Your key generated by OpenAI. GitKraken Desktop uses `gpt-3.5-turbo` model for generating commit messages.

**OpenAI Model:** This is the OpenAI model that will be used to generate the commit message. 
...
To specifically generate an API key for GitKraken Desktop to use:
