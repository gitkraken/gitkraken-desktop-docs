...
Subscriptions are tied directly to an [organization](/gitkraken-desktop/gitkraken-organization/), even if the subscription is for one user. The subscription is identical for everyone in the organization and one license is required for every member (unless their [role](/gitkraken-desktop/gitkraken-organization/#roles) does not use a license).

## How to Purchase
To purchase a subscription for the first time follow these steps:
1. Visit [app.gitkraken.com](https://app.gitkraken.com/).
2. Login with your [GitKraken account](/gitkraken-desktop/gitkraken-account/) or create an account.
3. Select your organization in the left panel and select "Purchase License" (remember you need to have a [role](/gitkraken-desktop/gitkraken-organization/#roles) with permission to purchase). If you intend to purchase on another organization, select “Create organization.”
